...
export default class HooButtonPrimary extends React.Component<IButtonProps, IButtonState> {
  ...
  public render(): React.ReactElement<IButtonProps> {
    try {
      return (
        <button className="hoo-button-primary" disabled={this.props.disabled} aria-disabled={this.props.disabled} onClick={this.props.onClick}>
